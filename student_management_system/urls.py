...
urlpatterns = [
    ...
    # Add details for Staff, Course, Subject, Session and Student
    ...
    # Manage Staff, Course, Subject, Session and Student
    ...
    # Edit Staff, Student, Course and Subject
    ...
    # Feedback Reply for Student and Staff
    ...
    # Leave View for Student and Staff
    ...
    path('sent_student_notification', HodViews.sent_student_notification, name="sent_student_notification"),
    path('sent_staff_notification', HodViews.sent_staff_notification, name="sent_staff_notification"),
    ...
    # Staff Take and Update Attendance
    ...
    # Staff Apply for Leave and Feedback
